...
cd postgresql-connection-pool-and-query-suite/pgsql_connection_pool/

g++  -c  postgresql_connection_pool.cpp  postgresql_query_example.cpp 

g++ postgresql_connection_pool.o postgresql_query_example.o  -o psqgl_conn_pool_example  -lpq -lpqxx
```
## RUN
```
./psqgl_conn_pool_example
```

#  code example for including inisde your project:
```
#include <stdio.h>
#include <cstring>
#include <iostream>
